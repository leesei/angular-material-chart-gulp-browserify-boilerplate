...
> ## Background
> 
> This project is based on [jakemmarsh/angularjs-gulp-browserify-boilerplate](https://github.com/jakemmarsh/angularjs-gulp-browserify-boilerplate) with the following modifications:
> - add Angular Material
> - add chart libraries
> - use `bower` for client dependencies
> - replace [`browserify-shim`](https://github.com/thlorenz/browserify-shim) with [`debowerify`](https://github.com/eugeneware/debowerify), which is [more bower friendly](http://stackoverflow.com/questions/24169482/angular-modules-and-browserify)
> - add `gulp-cssimport`
> 
...
1. Clone this repo from `https://github.com/leesei/angular-material-chart-gulp-browserify-boilerplate.git`
2. Run `npm install` and `bower install` from the root directory (may require installing Bower globally `npm install bower -g`)
